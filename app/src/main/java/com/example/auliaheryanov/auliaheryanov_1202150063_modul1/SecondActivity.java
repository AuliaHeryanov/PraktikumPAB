package com.example.auliaheryanov.auliaheryanov_1202150063_modul1;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast ya =	Toast.makeText(context,	"Sikat gannnn",	Toast.LENGTH_LONG);
        Toast tidak = Toast.makeText(context, "Ga cukup duitnya, yang lain aja", Toast.LENGTH_LONG);
